...
public class LrcView extends View implements ILrcView {
     ...
     **/
    private int mSeekLineTextSize = 50;
    /**
     ...
     **/
    private int mMaxSeekLineTextSize = 100;
    /**
     * 拖动歌词时，展示当前高亮歌词字体大小
     **/
    private int mGLLrcFontSize = 80;
    /**
     * 歌词字体大小默认值
     **/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDisplayMode==DISPLAY_MODE_SEEK){
            mPaint.setTextSize(mGLLrcFontSize);
        }else {
            mPaint.setTextSize(mLrcFontSize);
        }
