package com.pk.PkMusic.utils.geci;
...
public class LrcRow implements Comparable<LrcRow>{
    ...
    public static List<LrcRow> createRows(String standardLrcLine){
         ...
         **/
        try{
            if(standardLrcLine.replaceAll(" ","").indexOf("[") != 0 || standardLrcLine.replaceAll(" ","").indexOf("]") != 9 ){
                return null;
            }
            //[02:34.14][01:07.00]当你我不小心又想起她
            //找到最后一个 ‘]’ 的位置
             ...
             */
            String times = standardLrcLine.substring(0,lastIndexOfRightBracket + 1).replace("[", "-").replace("]", "-").replaceAll(" ","");
            //通过 ‘-’ 来拆分字符串
